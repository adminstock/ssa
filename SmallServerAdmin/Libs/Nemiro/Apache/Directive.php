...
namespace Nemiro\Apache
{
  ...
  /**
   * Represents Apache section or directive.
   * 
  ...
  class Directive implements \ArrayAccess
  {
    ...
    /**
     * The name of section or directive.
     * 
     * @var \string
     */
    public $Name;
    ...
    function __construct($name, $parameters = NULL, $childs = NULL)
    {
      ...
      if (!is_null($childs) && gettype($childs) != 'object' && get_class($childs) != 'Nemiro\Apache\DirectiveCollection')
      {
        throw new \InvalidArgumentException('The parameter $childs expected values of the Nemiro\Apache\DirectiveCollection type.');
      }
    ...
    /**
     * Adds new parameter to the parameter collection of the current instance.
     * 
    ...
    /**
     * Adds a new directive or section to the collection of the current instance.
     * 
    ...
    public function AddDirective($nameOrInstance, $parameters = NULL, $childs = NULL)
    {
      ...
      if (gettype($nameOrInstance) == 'object' && (($class = get_class($nameOrInstance)) == 'Nemiro\Apache\Directive' || $class == 'Nemiro\Apache\DirectiveGroup'))
      {
    ...
    /**
     * Determines the group or single section or directive.
     * 
     * @return \bool
     */
    public function IsGroup()
    {
      return get_class($this) == 'Nemiro\Apache\DirectiveGroup';
    }

    /**
     * Determines the section or not.
     * 
     * Sections contain many nested sections and directives.
     * 
     * @return \bool
     */
    ...
    /**
     * Determines the directive or not.
     * 
     * Directives contain only parameters.
     * 
     * @return \bool|\NULL
     */
    public function IsDirective()
    {
      if ($this->IsGroup())
      {
        if ($this->HasChild())
        {
          return $this->FirstChild()->IsDirective();
        }
        else
        {
          return NULL;
    ...
    /**
     * Returns the first child of the current instance.
     * 
     * @return Directive|DirectiveGroup
     */
    ...
    /**
     * Returns the last child of the current instance.
     * 
     * @return Directive|DirectiveGroup
     */
    ...
    /**
     * Determines whether the child collection contains the element with specified name.
     * 
